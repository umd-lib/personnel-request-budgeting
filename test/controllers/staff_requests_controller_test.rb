...
class StaffRequestsControllerTest < ActionController::TestCase
  ...
  test "should create staff_request" do
    assert_difference('StaffRequest.count') do
      post :create, staff_request: { annual_base_pay: @staff_request.annual_base_pay, department_id: @staff_request.department_id, employee_type_id: @staff_request.employee_type_id, justification: @staff_request.justification, nonop_funds: @staff_request.nonop_funds, nonop_source: @staff_request.nonop_source, position_description: @staff_request.position_description, request_type_id: @staff_request.request_type_id, subdepartment_id: @staff_request.subdepartment_id }
    end
  ...
  test "should update staff_request" do
    patch :update, id: @staff_request, staff_request: { annual_base_pay: @staff_request.annual_base_pay, department_id: @staff_request.department_id, employee_type_id: @staff_request.employee_type_id, justification: @staff_request.justification, nonop_funds: @staff_request.nonop_funds, nonop_source: @staff_request.nonop_source, position_description: @staff_request.position_description, request_type_id: @staff_request.request_type_id, subdepartment_id: @staff_request.subdepartment_id }
    assert_redirected_to staff_request_path(assigns(:staff_request))
  end
