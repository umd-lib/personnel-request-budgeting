...
class ApplicationHelperTest < ActionView::TestCase
  ...
  test 'verify help-text-icon content when provided a valid translation key' do
    existing_translation_key = 'help_text.position_title'
    expected_help_test = raw t('help_text.position_title')
  ...
  test 'verify confirm_delete_text content when given objects of different types' do
    ...
    test_cases = { contractor_requests(:c2) => contractor_requests(:c2).position_title,
                   ...
                   labor_requests(:c1) => labor_requests(:c1).position_title,
                   ...
                   staff_requests(:fac) => staff_requests(:fac).position_title,
