...
# Integration test for the Salaried Contractor Requests Cost Summary Report
class ContractorRequestCostSummaryReportTest < ActionDispatch::IntegrationTest
  ...
  def spreadsheet
    ...
    @@report_params = { name: 'ContractorRequestsCostSummaryReport',
                        format: 'xlsx',
